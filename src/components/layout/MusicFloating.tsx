...
export default function MusicFloating() {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex items-center gap-2 sm:gap-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur rounded-full shadow-lg border border-gray-200 dark:border-gray-700 px-3 sm:px-4 py-2.5 ring-2 ring-orange-400/40">
      ...
      <div className="overflow-hidden max-w-[120px] hidden sm:block">
