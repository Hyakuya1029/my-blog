  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-white">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-indigo-200 rounded-full opacity-20 blur-3xl animate-pulse" />
      ...
      <div className="relative z-10 text-center px-4">
        {/* 404 数字 */}
        <div className="text-9xl font-bold text-gray-800 mb-4 tracking-tight">
          404 NOT FOUND
        </div>
